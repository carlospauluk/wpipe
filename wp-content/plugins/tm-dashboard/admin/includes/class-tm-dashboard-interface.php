<?php
/**
 * Re-build WordPress Admin menu for TemplateMonster Dasboard and load interface.
 *
...
if ( ! class_exists( 'TM_Dashboard_Interface' ) ) {
	...
	class TM_Dashboard_Interface {
		...
		/**
		 * TemplateMonster menu item position.
		 *
		 * @since 1.0.0
		 * @var int
		 */
		...
		/**
		 * Subpages list for TemplateMonster menu item.
		 *
		 * @since 1.0.0
		 * @var array
		 */
		...
		public function register_new_pages() {
			$menu_page_args = apply_filters( 'tm_dashboard_menu_page_args', array(
				'page_title' => esc_html__( 'TemplateMonster Dashboard', 'tm-dashboard' ),
				'menu_title' => esc_html__( 'TemplateMonster', 'tm-dashboard' ) . tm_update_notices()->menu_bage,
				'capability' => 'manage_options',
				'menu_slug'  => $this->get_menu_slug(),
				'function'   => array( $this, 'build_page' ),
				'icon_url'   => tm_dashboard()->plugin_url( 'admin/assets/img/tm-icon-2.svg' ),
		...
		/**
		 * Get registered subpages list for TemplateMonster menu.
		 *
		 * @since 1.0.0
		 * @return array
		 */
		public function subpages() {
			...
			$this->subpages = apply_filters( 'tm_dashboard_subpages', array(
				$this->get_menu_slug() => array(
					'page-title' => esc_html__( 'Welcome to TemplateMonster Dashboard!', 'tm-dashboard' ),
					'menu-title' => esc_html__( 'Dashboard', 'tm-dashboard' ),
					'depends'    => array(),
				),
				'tm-updates' => array(
					'page-title' => esc_html__( 'TemplateMonster Updates', 'tm-dashboard' ),
