...
?>
<form action="" id="tm-rateform" class="tm-rate-form">
	<fieldset>
	...
	<div class="tm-rate-form__btns">
		<button class="tm-rate-form__btn cherry5-ui-button cherry5-ui-button-primary-style" type="submit">
			<span class="tm-rate-form__btn-text"><?php esc_html_e( 'Send', 'tm-dashboard' ); ?></span>
			<span class="tm-rate-form__btn-loader"><span class="loader"></span></span>
			<span class="tm-rate-form__btn-icon dashicons dashicons-yes"></span>
		</button>
	</div>
</form>
